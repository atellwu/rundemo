...
(function(a, b) {
	a.fn.ace_tree = function(d, headId) {
		var c = {
			...
			"headId" : headId//添加headId参数，每次刷新页面重新加载文件树传进来
		};
		c = a.extend({}, c, d);
		this
				.each(function() {// <div class="tree-loader"
									// style="display:none">
					var e = a(this);
					e
							.html('<div class = "tree-folder" style="display:none;"><div class="tree-folder-header"><i class="'
									+ c["close-icon"]
									+ '"></i><div class="tree-folder-name"></div>	</div><div class="tree-folder-content"></div></div></div><div class="tree-item" style="display:none;">'
