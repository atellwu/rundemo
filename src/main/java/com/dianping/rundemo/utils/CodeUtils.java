...
public class CodeUtils {
    ...
    public static JavaFileInfo getJavaFileInfo(File file, String app) throws IOException {
        ...
        //path
        String path = file.getPath().replace(Config.shellDir + "/appprojects/" + app + "/", "");
    ...
    public static void main(String[] args) throws IOException {
        ...
        //      System.out.println(mm.matches());
        //      System.out.println(mm.group(1));
        System.out.println(CodeUtils.getJavaFileInfo(new File(Config.shellDir
                + "/appprojects/swallow-example/src/main/java/com/dianping/swallow/example/consumer/DurableConsumerExample.java"),
                "swallow-example"));
    }
}
